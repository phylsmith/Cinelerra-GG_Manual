...
\begin{lstlisting}[style=sh]
	CinGG-20251231-x86_64.AppImage
	  (currently based on Fedora 32, linux kernel 5.8.15, libc version 2.31)
	CinGG-20251231-x86_64-older-distros.AppImage, but with libaom version 3.4.0.
	  (currently based on Ubuntu 16.04, libc version 2.23)
	CinGG-20251231-alternative_shortcuts.AppImage, but with libaom version 3.4.0.
	  (currently based on Ubuntu 16.04, libc version 2.23)
	CinGG-20251231-i386.AppImage, but with version R3106 for the x264 library,
	  (currently based on Debian 9, linux kernel 4.9, use "newer" for Debian 11.0)
	CinGG-20251231-i386-newer-distros.AppImage
...
Centos, Arch, Slackware, Gentoo, and many more less used distros and variations. 
