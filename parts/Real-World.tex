...
%begin{latexonly}
\url{https://download.cinelerra-gg.org/download.php?file=testing\%2Fcinelerra-Manual-reference.zip}
%end{latexonly}
\begin{htmlonly}
\url{https://download.cinelerra-gg.org/download.php?file=testing\%2Fcinelerra-forum.zip}
\end{htmlonly}
